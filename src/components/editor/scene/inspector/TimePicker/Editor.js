...
const TimepickerEditor = ({ control, scene, viewController, onCreate, onEdit, onDelete, onConnect, onDisconnect }) => {
    const timepicker = control;
    return (
        <Card className="w-100">
            ...
            <Card.Body>
                <Tab.Container id="timepicker-props-editor" defaultActiveKey="main">
                    ...
                    <Tab.Content>
                        <Tab.Pane eventKey="main">
                            <Form>
                                <ControlText caption="Name" value={timepicker.name} onChange={value => onEdit('name', value)} />
                            </Form>
                        </Tab.Pane>
                        ...
                        <Tab.Pane eventKey="dimension">
                            <DimensionTab uiPhoneControl={timepicker} onEdit={onEdit} />
                        </Tab.Pane>
                        <Tab.Pane eventKey="spacing">
                            <SpacingTab uiPhoneControl={timepicker} onEdit={onEdit} enableMargin={true} enablePadding={true} />
                        </Tab.Pane>
                        <Tab.Pane>
                            <ModelTab
                                scene={scene}
